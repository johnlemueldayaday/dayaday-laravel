        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between py-3">
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-2xl font-bold text-gray-800 pl-14">International Horizon School</span>
                </div>
        ...
        <div class="max-w-9xl mx-auto px-6 lg:px-34 py-10">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-0">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-200">935 International Horizon School, Cebu, Canada</p>
